...
| `apps/web/src/render/world.ts`, `render/butterbell-{art,backdrop,farm,foliage,ground,landscape,materials}.ts` and `packages/content/src/index.ts` | Butterbell dairy-festival environment-art checkpoint | Original spline layout, banks, branching apple trees with interlocking crowns and folded leaf sprays, planted cobbled farmyards, low meadow drifts, gambrel farms, fitted foundations, silos, lattice windmill, hay bales and bell gantry. Seven ground/building textures, painted bark/leaf textures and a lettering atlas are generated locally. Terrain clipping exposes the existing physical road; rolling countryside and a distant dairy hamlet lie outside playable bounds. No external images, game scenery or models | Visual designs/generated art: CC BY 4.0; implementation code: MIT |
