...
| `apps/web/src/render/kart.ts`, `render/characters/`, and `render/parts/` | Reproportioned playable roster and modular kart models; finishing ongoing | Original procedural models for the eight approved characters, eight bodies, six wheel sets, four gliders, paints and decals. Shaped jaws and muzzles, shallow eye sockets, tailored sleeves and gripping hands, rolled/sculpted hair, folded ears, and character-specific backs replace generic stacked volumes. Recessed cockpits, tire tread, hubs, suspension and canopy rigging share the existing mounting interfaces. Geometry is recreated at runtime from editable source | Visual designs/generated art: CC BY 4.0; implementation code: MIT |
| `apps/web/src/render/items.ts` and `render/item-art.ts` | Reauthored item and delivery-pickup models | Original curved/beveled geometry for all standard items, triple variants and four signature specials. Wax sachets, rubber reels, chimes, clock faces, pressure vessels, calipers, wind-up wings, upholstered bumpers and inflatable decoys use distinct finishes. The double-sided delivery case has curved ticket reels, cast corner protectors, recessed windows, catches and a rounded handle. No imported meshes, textures or external generation | Visual designs/generated art: CC BY 4.0; implementation code: MIT |
...
| `apps/web/src/render/world.ts`, `render/butterbell-{art,backdrop,farm,fields,foliage,ground,landscape,materials}.ts` and `packages/content/src/index.ts` | Butterbell dairy-festival environment-art checkpoint | Original spline layout, banks, branching apple trees with interlocking crowns and folded leaf sprays, planted cobbled farmyards, low meadow drifts, gambrel farms, fitted foundations, silos, a timber-gallery windmill with two-sided sail framing, hay bales and bell gantry. Seven ground/building textures, painted bark/leaf textures, a lettering atlas and a world-space painting of 16 cultivated fields are generated locally. Eight shaped field hedges reuse the leaf painting. Terrain clipping exposes the existing physical road; rolling countryside, grouped broad-canopy woodland and a detailed dairy hamlet lie outside playable bounds, with scenery grounded on the rendered hillside triangles. No external images, game scenery or models | Visual designs/generated art: CC BY 4.0; implementation code: MIT |
| `apps/web/src/render/groundcover.ts` and `render/course-groundcover.ts` | Small foliage across all six courses | Original folded grass, clover, daisies, buttercups, seed heads, reeds, fern fronds, ornamental rosettes and arcade felt flowers. Course-specific palettes, deterministic meadow/orchard/pond planting, shallow terminal and galleria troughs, bark pockets and alpine stone-edge beds. Shared opaque vertex-colored geometry; no downloaded textures, sprites, plant scans or external generation | Visual designs/generated art: CC BY 4.0; implementation code: MIT |
